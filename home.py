...
def run_home():
    ...
    st.markdown('''
                ...
                - 본 서비스는 **사용자**에게 **한국과 중국의 대기오염 데이터를 비교**하여 그 **관계성을 분석**할 수 있는 기능을 제공하고,
                - 중국의 대기오염 물질들이 **실제로 한국의 대기오염 물질에 영향**을 얼마나 미치는지 분석 보고서를 작성하기 위함''')
    
    st.markdown('''
                ### 서비스 목적
                - 한국과 중국의 대기오염물질들의 농도 분석 기능 제공
                - 한국과 중국의 대기오염물질들의 예측 기능 제공
                - 한국과 중국의 (초)미세먼지 농도 관계성 분석 보고서 작성                
                ''')
